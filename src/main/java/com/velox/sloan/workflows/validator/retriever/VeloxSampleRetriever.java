...
public class VeloxSampleRetriever implements SampleRetriever {
    ...
    public VeloxSampleRetriever(Map<String, DataRecord> sampleIgoIdToRecord, DataRecordManager dataRecordManager, User user, CmoSampleInfoConverter cmoSampleInfoConverter) {
